...
public class UtilityBelt {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		/*// build some dummy menus here for now
		UtilityMenu rootMenu = new UtilityMenu("root");
		rootMenu.addButton(new UtilityButton("&6Home", "/home"));
		rootMenu.addButton(new UtilityButton("&eSpawn", "/spawn"));
		rootMenu.addButton(new UtilityButton("&c&nGame Modes", "##gameMode"));
		rootMenu.addButton(new UtilityButton("&dKits", "##kits"));
		menus.put("root", rootMenu);
		
		UtilityMenu gameModeMenu = new UtilityMenu("gameMode");
		gameModeMenu.addButton(new UtilityButton("&2Survival", "/gm 0"));
		gameModeMenu.addButton(new UtilityButton("&3Creative", "/gm 1"));
		gameModeMenu.addButton(new UtilityButton("&4Adventure", "/gm 2"));
		menus.put("gameMode", gameModeMenu);*/
	}
